...
public class BadRequest {
    ...
    public BadRequest(String mensaje, String folio, String detalle) {
        this.codigo = "400.meli-developer-productos.4000"; 
        this.mensaje = mensaje;
        this.folio = folio;
        this.detalle = detalle;
        this.info = "https://meli.com.mx/info#400.meli-developer-productos.4000";
    }

    public BadRequest(String campoFaltante, String folio) {
        this.codigo = "400.meli-developer-productos.4004";
        ...
        this.info = "https://meli.com.mx/info#400.meli-developer-productos.4004"; 
    }

    public BadRequest(String mensaje, String folio, boolean folioNoEncontrado) {
        this.codigo = "400.meli-developer-productos.4006";
        this.mensaje = mensaje;
        this.folio = folio;
        this.detalle = mensaje;
        this.info = "https://meli.com.mx/info#400.meli-developer-productos.4006";
    }
